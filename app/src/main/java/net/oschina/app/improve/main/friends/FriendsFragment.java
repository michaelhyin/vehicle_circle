package net.oschina.app.improve.main.friends;
...
public class FriendsFragment extends BasePagerFragment implements OnTabReselectListener {
...
//        fragments.add(TweetFragment.newInstance(TweetFragment.CATALOG_MYSELF));
    ...
    protected String[] getTitles() {
        return getResources().getStringArray(R.array.friends_titles);
//        return null;
    }
