...
class SubPresenter implements SubContract.Presenter {
    ...
    public void onRefreshing() {
        LeanCloudApi.getSubscription2(mTab.getHref(), "", new TextHttpResponseHandler() {
            @Override
            ...
            public void onSuccess(int statusCode, Header[] headers, String responseString) {
                try {
                    responseString = LeanCloudPatternOpt.getTucaoListStr(responseString);
    ...
    public void onLoadMore() {
        LeanCloudApi.getSubscription2(mTab.getHref(), mNextToken, new TextHttpResponseHandler() {
            @Override
            public void onFailure(int statusCode, Header[] headers, String responseString, Throwable throwable) {
                mView.showNetworkError(R.string.network_timeout_hint);
                mView.onComplete();
