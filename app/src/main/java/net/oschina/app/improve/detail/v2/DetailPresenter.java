...
public class DetailPresenter implements DetailContract.Presenter {
    ...
    public void getDetail() {
        LeanCloudApi.getDetail(mBean.getType(), mIdent, mBean.getId(), new TextHttpResponseHandler() {
            @Override
            ...
            public void onSuccess(int statusCode, Header[] headers, String responseString) {
                try {
                    responseString = LeanCloudPatternOpt.getTucaoDetailStr(responseString);
