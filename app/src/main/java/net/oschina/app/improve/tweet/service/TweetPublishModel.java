...
public class TweetPublishModel implements Serializable {
    ...
    private ArrayList<String> cacheImageUrls;
    ...
    public ArrayList<String> getCacheImageUrls()
    {
        return this.cacheImageUrls;
    }

    public void addCacheImageUrl(String imageUrl)
    {
        this.cacheImageUrls.add(imageUrl);
    }
