...
public class LeanCloudApiHttpClient {
    public final static String HOST = "www.leancloud.cn";
    //app id前8位
    public static String API_URL = "https://6b6zy16t.api.lncld.net/1.1/classes/%s";
    public static String CQURY_API_URL = "https://6b6zy16t.api.lncld.net/1.1/%s";
    ...
    public static void init(Application context) {
        ...
        // Set
        LeanCloudApiHttpClient.setHttpClient(client);
        // Set Cookie
    ...
    public static void get(String partUrl, RequestParams params,
        ...
        setHeaderNewsId();
        if(partUrl.contains("cloudQuery"))
            CLIENT.get(getAbsoluteCquryApiUrl(partUrl), params, handler);
        else
    ...
    public static String getAbsoluteCquryApiUrl(String partUrl) {
        setHeaderNewsId();
        String url = partUrl;
        if (!partUrl.startsWith("http:") && !partUrl.startsWith("https:")) {
            url = String.format(CQURY_API_URL, partUrl);
        }
        log("request:" + url);
        return url;
    }
    ...
    public static void post(String partUrl, HttpEntity entity, RequestParams params, AsyncHttpResponseHandler handler) {
        setHeaderNewsId();
        CLIENT.post(null, getAbsoluteApiUrl(partUrl), null, params, RequestParams.APPLICATION_JSON, handler);
        log("POST " + partUrl);
    }

    public static void post(String partUrl, HttpEntity entity, AsyncHttpResponseHandler handler) {
        setHeaderNewsId();
        CLIENT.post(null, getAbsoluteApiUrl(partUrl), entity, RequestParams.APPLICATION_JSON, handler);
        log("POST " + partUrl);
    }
    ...
    public static String getCookie(Header[] headers) {
        String cookie = getClientCookie(LeanCloudApiHttpClient.getHttpClient());
        if (TextUtils.isEmpty(cookie)) {
            cookie = "";
            if (headers != null) {
